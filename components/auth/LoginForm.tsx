  ...
  return (
    <div className="w-full max-w-md mx-auto space-y-6 p-8 bg-white rounded-xl shadow-sm border border-gris-piedra/10">
      <div className="text-center space-y-2">
        <h1 className="font-playfair text-3xl font-bold text-madera-oscura">Bienvenido</h1>
        <p className="text-gris-piedra font-dm-sans">Ingresa tus credenciales para acceder</p>
      </div>
      ...
      <div className="relative">
        <div className="absolute inset-0 flex items-center">
          <span className="w-full border-t border-gris-piedra/20" />
        </div>
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-white px-2 text-gris-piedra font-dm-sans">O continúa con</span>
        </div>
      </div>
